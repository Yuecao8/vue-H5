var vm = new Vue({
    ...
    methods: {
        ...
        getLunbo() {  
            var _this = this;
            // http://mapi.plus.hebtv.com/api/open/js/get_langfang_slide_pics?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59
            $.ajax({
                type: "GET",
                url: 'http://mapi.plus.hebtv.com/api/open/js/get_cangzhou_slide_pics?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59',
                dataType: 'json',
        ...
        // 分类数据
        // http://mapi.plus.hebtv.com/api/open/js/langfang_get_recommend_data?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59
        getData() {
            var _this = this;
            $.ajax({
                type: "GET",
                url: 'http://mapi.plus.hebtv.com/api/open/js/cangzhou_get_recommend_data?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59&fid=795',
                dataType: 'json',
                success: function (res) {
                    _this.tabList = res;
        ...
        getNews() {
            const _this = this;
            // http://mapi.plus.hebtv.com/api/open/js/get_langfang_slide_zixun?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59
            $.ajax({
                type: "GET",
                url: 'http://mapi.plus.hebtv.com/api/open/js/get_cangzhou_slide_zixun?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59',
                dataType: 'json',
                success: function (res) {
                    _this.newsList = {
                        topList: [],
        ...
        getMore(){
            const _this = this;
            this.page ++;
           // this.offset = (_this.page * _this.page) -1;
           this.offset =(_this.page - 1) * _this.count;
            $.ajax({
                type: "GET",
                url: 'http://mapi.plus.hebtv.com/api/open/js/cangzhou_column_contents.php?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59&count='+_this.count+'&offset='+_this.offset+'&column_id='+_this.currentId,
