...
var vm = new Vue({
    ...
    methods: {
        ...
        getLunboData() {
            ...
            $.ajax({
                type: "GET",
                url: _this.host + 'api/open/js/get_ms_slide_pics?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59',
                dataType: 'json',
        ...
        getSortData() {
            ...
            $.ajax({
                type: "GET",
                url: _this.host + 'api/open/js/sh_get_recommend_data?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59&fid=' + 27,
                dataType: 'json',
                success: function (res) {
                    _this.sortList = res;
                    res.forEach((item) => {
