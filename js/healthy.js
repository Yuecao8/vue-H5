...
var vm = new Vue({
    ...
    methods: {
        ...
        getLunboData() {
            // http://mapi.plus.hebtv.com/api/open/js/get_jk_slide_pics?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59
            const _this = this;
            $.ajax({
                type: "GET",
                url: _this.host + 'api/open/js/get_jk_slide_pics?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59',
                dataType: 'json',
        ...
        getSortData() {
            ...
            $.ajax({
                type: "GET",
                url: _this.host + 'api/open/js/sh_get_recommend_data?appid=m2ovki73ruqwcwmw8b&appkey=b7269c8f9a318c69a59dc430cef3ab59&fid=' + 26,
                dataType: 'json',
                success: function (res) {
                    res.forEach(item => {
